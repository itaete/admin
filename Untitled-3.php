...
<!--strong>Id: </strong> <?=$linha['ID']?>    <br/>
<strong>Login: </strong> <?=$linha['Login']?>    <br/>
<strong>Nome: </strong> <?=$linha['Nome']?>    <br/>
<strong>Sobrenome: </strong> <?=$linha['Sobrenome']?>   <br/>  
<strong>Email: </strong> <?=$linha['Email']?>    <b
<strong>Senha: </strong> <?=$linha['Senha']?>    <br/-->
...
<div class="form-group">
<label for="exampleInputFile"><em>Nome</em></label>
...
<div class="form-group">
<label for="exampleInputFile"><em>Sobrenome</em></label>
...
<div class="form-group">
<label for="exampleInputFile"><em>Senha</em></label>
...
<div class="form-group">
<label for="exampleInputFile"><em>Data de nascimento</em></label>
<input class="form-control" placeholder="Data nacimento" name="datanasc" id="datanasc" value="">
</div>
		 
         

<div class="form-group">
<label for="exampleInputFile"><em>Imagem</em></label>
 <input name="imagem" type="file" id="imagem" size="99" />
</div>
