		...
		<script type="text/javascript">
			$(document).ready(function(){
				$('#meu_form').validate({
					...
					messages:{
						login:{ 
							required: "<img src='alerta.gif'/>",
							minlength: "<img src='alerta.gif'/>"
						},
						nome:{ 
							required: "<img src='alerta.gif'/>",
							minlength: "<img src='alerta.gif'/>"
						...
						conf_senha:{
							required: "<img src='alerta.gif'/>",
							equalTo: "<img src='alerta.gif'/>"
						},
						termos: "<img src='alerta.gif'/>"
					}
...
<div class="col-md-4" style="float:right">
    		<div class="panel panel-default">
			  	<div class="panel-heading">
			    	<h3 class="panel-title">Cadastre- se agora</h3>
			 	</div>
			  	<div class="panel-body">
<form action="InsereCadastro.php" method="post" enctype="multipart/form-data" name="formcadastro" id="meu_form" role="form">
                    <fieldset>
...
<input class="form-control" placeholder="Username" value="" name="login" id="username"
onkeyup="twitter.updateUrl(this.value)">


 &nbsp; http://localhost/<span id="username_url">usuario</span> <span id="status"></span>
